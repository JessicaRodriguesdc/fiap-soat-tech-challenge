...
public class ProductControllerTest {
    ...
    public void testCreateProduct() throws Exception {
        ...
        ProductRequestDTO requestDTO = new ProductRequestDTO("Sanduíche de Frango", CategoryProductEnum.MAIN_COURSE, BigDecimal.valueOf(99.99), "Sanduíche de frango com salada");
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/v1/products")
                        ...
                        .content("{\"name\":\"Sanduíche de Frango\",\"category\":\"MAIN_COURSE\",\"price\":99.99,\"description\":\"Sanduíche de frango com salada\"}")
    ...
    public void testUpdateProduct() throws Exception {
        ...
        ProductRequestDTO requestDTO = new ProductRequestDTO("Sanduíche de Bacon", CategoryProductEnum.MAIN_COURSE, BigDecimal.valueOf(199.99), "Sanduíche de bacon com salada");
        ProductResponseDTO responseDTO = new ProductResponseDTO(product);
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/v1/products/{id}", id)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"name\":\"Sanduíche de Bacon\",\"category\":\"MAIN_COURSE\",\"price\":199.99,\"description\":\"Sanduíche de bacon com salada\"}")
                        .accept(MediaType.APPLICATION_JSON))

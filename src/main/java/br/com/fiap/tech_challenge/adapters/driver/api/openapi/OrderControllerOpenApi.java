...
public interface OrderControllerOpenApi {
	...
	@ApiResponse(responseCode = "200", description = "Ok Response",
			content = @Content(mediaType = "application/json", schema = @Schema(ref = "PageableOrderResponseDTO")))
	...
	@ApiResponse(responseCode = "500", description = "Internal Server Error Response",
			content = @Content(mediaType = "application/json", schema = @Schema(ref = "ProblemDto")))
	ResponseEntity<Page<OrderSummaryResponseDTO>> findAllIsPaidOrders(OrderStatusEnum status, Boolean isPaid, int page,
			int size);

...
public interface CustomerControllerOpenApi {
    ...
    @ApiResponse(responseCode = "200", description = "Ok Response", content = @Content(mediaType = "application/json", schema = @Schema(ref = "CustomerResponseDTO")))
    ...
    @ApiResponse(responseCode = "201", description = "Created Response", content = @Content(mediaType = "application/json", schema = @Schema(ref = "CustomerResponseDTO")))

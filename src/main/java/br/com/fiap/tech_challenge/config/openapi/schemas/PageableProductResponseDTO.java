...
public record PageableProductResponseDTO(
        @Schema(example = "1") Long totalPages,
        @Schema(example = "1") Long totalElements,
        @Schema(example = "10") Long size,
        List<ProductResponseDTO> content,
        @Schema(example = "0") Long number,
        PageableSortProductResponseDTO sort,
        @Schema(example = "true") Boolean first,
        @Schema(example = "true") Boolean last,
        @Schema(example = "1") Long numberOfElements,
        PageablePageableProductResponseDTO pageable,
